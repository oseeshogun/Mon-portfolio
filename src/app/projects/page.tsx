  ...
  return (
    <div className="flex-1 p-6 overflow-auto">
      <div className="max-w-5xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-bold text-vscode-text mb-4 font-mono">
            Side Projects
          </h1>
          <p className="text-vscode-text text-lg leading-relaxed">
            Here are some of my notable personal projects, hobbies and open
            source projects. Each one represents a unique challenge and
            demonstrates my expertise in different technologies.
          </p>
        </div>
